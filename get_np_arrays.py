...
def npy_from_pkl(label, suffix="", load_NN=True, pkl_path="",
...
if __name__ == '__main__':
    ...
    LABEL = f"{mc}_{run_type}_{mc}_{run_identifier}"

    # Rapgap_nominal_Rapgap_SingleWorker_Q2_Cut
    npy_from_pkl(LABEL, mc=mc)
